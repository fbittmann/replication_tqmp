...
eststo M1: estpost summarize mean1 mean2 sd1 sd2 n1 n2, det
esttab M1 using "Deskription_baseline.rtf", ///
...
graph bar coverage*, exclude0 ylabel(0.93(0.005)0.96) ///
	...
	name(g1, replace) title("Baseline simulation (Normal)") ytitle("Coverage")
graph save "all_baseline", replace
graph export "all_baseline.png", replace width(2500)
