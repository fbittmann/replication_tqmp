...
esttab M1 using "Deskription_uniform.rtf", ///
...
use `file', clear
list
export excel using "res_uniform", replace firstrow(variables)
restore
...
graph bar coverage*, exclude0 ylabel(0.93(0.005)0.96) ///
	...
	name(g1, replace) title("Uniform distribution") ytitle("Coverage")
graph save "all_uniform", replace
graph export "all_uniform.png", replace width(2500)
