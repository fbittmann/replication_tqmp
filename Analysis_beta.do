...
gen absdiff_skew = abs(skew1 - skew2)
sum absdiff_skew, det

gen absdiff_kurt = abs(kurt1 - kurt2)
sum absdiff_kurt, det
...
recode ratio_sd (1/1.3 = 0) (1.3/2.2 = 1) (2.2/5.3 = 2), gen(ratio_sd_cat)
label define ratio_sd_cat 0 "1/1.3" 1 "1.3/2.2" 2 "2.2/5.3"
...
recode absdiff_skew (0/0.10 = 0) (0.10/0.36 = 1) (0.36/3 = 2), gen(absdiff_skew_cat)
label define absdiff_skew_cat 0 "0/0.10" 1 "0.10/0.36" 2 "0.36/3"
label values absdiff_skew_cat absdiff_skew_cat

recode absdiff_kurt (0/0.20 = 0) (0.20/0.85 = 1) (0.85/11 = 2), gen(absdiff_kurt_cat)
label define absdiff_kurt_cat 0 "0/0.20" 1 "0.20/0.85" 2 "0.85/11"
label values absdiff_kurt_cat absdiff_kurt_cat
...
label var skew1 "Skewness 1"
label var skew2 "Skewness 2"
label var kurt1 "Kurtosis 1"
label var kurt2 "Kurtosis 2"
label var ratio_sd "Ratio SD"
label var ratio_n "Ratio N"
label var unequalsd "Unequal SD"
label var absdiff_skew "Abs. diff. skewness"
label var absdiff_kurt "Abs. diff. kurtosis"
eststo M1: estpost summarize mean1 mean2 sd1 sd2 n1 n2 skew1 skew2 ///
	kurt1 kurt2 ratio_sd ratio_n unequalsd absdiff_skew absdiff_kurt, det
esttab M1 using "Deskription_beta.rtf", ///
...
postfile `name' str16 first str9 Basic1 str9 Basic2 ///
	...
	using `file', replace
foreach VAR of varlist all minsize_cat absdiff_skew_cat absdiff_kurt_cat {
...
use `file', clear
list
export excel using "res_beta", replace firstrow(variables)
restore
...
use `file', clear
list
export excel using "res_width_uniform", replace 
restore
...
graph bar coverage*, exclude0 ylabel(0.93(0.005)0.96) ///
	...
	name(g1, replace) title("Beta distribution") ytitle("Coverage")
graph save "all_beta", replace
graph export "all_beta.png", replace width(2500)
